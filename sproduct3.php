...
<body>
  ...
  <section id="prodetail" class="section-p1">
    <div class="single-pro-image">
      <img src="images/asusrogstrix.jpg" width="100%" id="mainimg">
      <div class="small-img-g">
        <div class="small-img-col">
          <img src="images/asusrogstrix2.jpg" width="100% " class="small-img">
        </div>
        <div class="small-img-col">
          <img src="images/asusrogstrix3.jpg" width="100% " class="small-img">
        </div>
        <div class="small-img-col">
          <img src="images/asusrogstrix4.jpg" width="100% " class="small-img">
        </div>
        <div class="small-img-col">
          <img src="images/asusrogstrix.jpg" width="100% " class="small-img">
        </div>
      </div>
    </div>
    <div class="sigle-pro-details">
      <!-- <h6>Mobile</h6> -->
      <h4>Asus Rog Strix Scar 15</h4>
      <h2>MRP: ₹2,50,999.00</h2>
      <input type="number" value="1">
      <button class="normal">Add To Cart</button>
      <h4>Product Details</h4>
      <span>15.6 Inches 2K Wqhd 240Hz | 3Ms Intel Core I9-12900H 12Th Gen Rtx 3070 Ti 8Gb Graphics | Gaming Laptop
        (32Gb/1Tb Ssd/Windows 11 Home/Office 2021/2.3 Kg) | 32GB DDR5 4800MHz | NVMe M.2 Performance
        SSD
      </span>
