...
<body>
  ...
  <section id="prodetail" class="section-p1">
    <div class="single-pro-image">
      <img src="images/iphone13pro.jpg" width="100%" id="mainimg">
      <div class="small-img-g">
        <div class="small-img-col">
          <img src="images/iphone13pro1.jpg" width="100% " class="small-img">
        </div>
        <div class="small-img-col">
          <img src="images/iphone13pro2.jpg" width="100% " class="small-img">
        </div>
        <div class="small-img-col">
          <img src="images/iphone13pro.jpg" width="100% " class="small-img">
        </div>
        <div class="small-img-col">
          <img src="images/iphone13pro1.jpg" width="100% " class="small-img">
        </div>
    ...
    <div class="sigle-pro-details">
      <!-- <h6>Mobile</h6> -->
      <h4>APPLE iPhone 13 Pro (Sierra Blue, 128 GB)</h4>
      <h2>MRP: ₹1,19,999.00</h2>
      <input type="number" value="1">
      <button class="normal">Add To Cart</button>
      <h4>Product Details</h4>
      <span>128 GB ROM | 15.49 cm (6.1 inch) Super Retina XDR Display | 12MP + 12MP + 12MP | 12MP Front Camera | A15
        Bionic Chip Processor | Hexa Core Apple A15 Bionic 6 GB RAM |
        Display. 6.1
        inches (15.49 cm) 457 PPI, OLED
      </span>
