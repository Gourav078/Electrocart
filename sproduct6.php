...
<body>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="images/samsungs203.png" width="100%" id="mainimg">
            <div class="small-img-g">
                <div class="small-img-col">
                    <img src="images/samsungs201.png" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/samsungs202.png" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/samsungs203.png" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/samsungs202.png" width="100% " class="small-img">
                </div>
        ...
        <div class="sigle-pro-details">
            ...
            <span>5G Snapdragon 865 Octa-Core processor, 8GB RAM, 128GB internal memory,
                Android 11.0 operating system | 12MP OIS
                F1.8 Rear Camera + 8MP OIS Tele Camera + 12MP | 30X Space Zoom, 32MP F2.2 Camera
            </span>
