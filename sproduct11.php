...
<body>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="images/nothing3.webp" width="100%" id="mainimg">
            <div class="small-img-g">
                <div class="small-img-col">
                    <img src="images/nothing1.webp" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/nothing2.webp" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/nothing3.webp" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/nothing4.webp" width="100% " class="small-img">
                </div>
            </div>
        </div>
        <div class="sigle-pro-details">
            <!-- <h6>Mobile</h6> -->
            <h4>Nothing Phone (1) (Black, 128 GB) (8 GB RAM)</h4>
            <h2>MRP: ₹33,499.00</h2>
            <input type="number" value="1">
            <button class="normal">Add To Cart</button>
            <h4>Product Details</h4>
            <span>
                8 GB RAM | 128 GB ROM(6.55 inch) Full HD+ Display
                50MP + 50MP | 16MP Front Camera
                4500 mAh Battery | Snapdragon 778G+ | Glyph Interface. A New Way to Communicate
                1 Billion Colours OLED Display with HDR10+.
            </span>
