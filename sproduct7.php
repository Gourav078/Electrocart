...
<body>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="images/redminote8pro.jpg" width="100%" id="mainimg">
            <div class="small-img-g">
                <div class="small-img-col">
                    <img src="images/redminote8pro1.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/redminote8pro2.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/redminote8pro3.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/redminote8pro.jpg" width="100% " class="small-img">
                </div>
            </div>
        </div>
        <div class="sigle-pro-details">
            <!-- <h6>Mobile</h6> -->
            <h4>Redmi Note 8 Pro(Electric Blue, 6GB RAM, 128GB Storage with Helio G90T Processor)</h4>
            <h2>MRP: ₹14,499.00</h2>
            <input type="number" value="1">
            <button class="normal">Add To Cart</button>
            <h4>Product Details</h4>
            <span>64MP AI Quad rear camera | powerful Helio G90T gaming processor | 16.58 centimeters (6.53-inch) Dot
                Notch HDR Display with 2340 x 1080 pixels resolution | 2.5D curved glass | 6GB
                RAM | 128GB internal memory.
            </span>
    ...
    <section id="pro-1" class="section-p1">
        ...
        <div class="pro-con">
            <div class="pro" onclick="window.location.href='sproduct13.php';">
                <img src="images/samsungm51.png" alt="" width="500" height="300">
