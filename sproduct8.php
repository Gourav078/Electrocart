...
<body>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="images/djimini3.jpg" width="100%" id="mainimg">
            <div class="small-img-g">
                <div class="small-img-col">
                    <img src="images/djimini1.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/djimini2.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/djimini3.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/djimini1.jpg" width="100% " class="small-img">
                </div>
        ...
        <div class="sigle-pro-details">
            ...
            <span>Foldable Camera Drone with
                Aerial Photography and Social Media | 4K HD, FHD 1080p |
                f/1.7 aperture for high-quality imagery, night and day | Capture your world in remarkable detail with
