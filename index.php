...
<body>
  <section id="header">
    ...
    <div>
      <ul id="navbar">
        ...
        <li><a id="lg-acc" href="index.php"><i class="fa-solid fa-circle-user"></i></a></li>
  ...
  <section id="hey">
    <h3>FROM IDEA TO ICONIC</h3>
    <h2>TECHNOLOGY ARE </h2>
    <h2>THE FUTURE</h2>
    <p>Discount upto 70% off</p>
    <button><a href="shop.php">Hurry Up</a></button>
  ...
  <section id="banner" class="section-m1">
    ...
    <h2>Upto <span>60% Off</span> - All Gadgets</h2>
  ...
  <section id="sm-banner" class="section-p1">
    <div class="banner-box">
      <h4>Crazy Deals</h4>
      <h2>Headphones Are In sale</h2>
      <span>Best Deals in Headphones</span>
      <button class="white">Learn More</button>
    </div>
    <div class="banner-box banner-box2">
      <h4>Crazy Deals</h4>
      <h2>Drones And laptop Sale </h2>
