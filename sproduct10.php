...
<body>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="images/msigf65thin.webp" width="100%" id="mainimg">
            <div class="small-img-g">
                <div class="small-img-col">
                    <img src="images/msigf65thin1.webp" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/msigf65thin2.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/msigf65thin3.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/msigf65thin4.jpg" width="100% " class="small-img">
                </div>
            </div>
        </div>
        <div class="sigle-pro-details">
            <!-- <h6>Mobile</h6> -->
            <h4>MSI GF65 Thin Core i7 10th Gen</h4>
            <h2>MRP: ₹89,990.00</h2>
            <input type="number" value="1">
            <button class="normal">Add To Cart</button>
            <h4>Product Details</h4>
            <span>16 GB/1 TB SSD/Windows 10 Home/6 GB Graphics/NVIDIA GeForce RTX 3060/144 Hz | Power Supply
                180 W AC Adapter |
                Intel
                Core i7
                10th Gen
