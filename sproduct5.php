...
<body>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="images/dji4.jpg" width="100%" id="mainimg">
            <div class="small-img-g">
                <div class="small-img-col">
                    <img src="images/dji2.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/dji3.png" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/dji4.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/dji5.jpeg" width="100% " class="small-img">
                </div>
            </div>
        </div>
        <div class="sigle-pro-details">
            <!-- <h6>Mobile</h6> -->
            <h4>DJI Mavic Mini Bundel 2 fly</h4>
            <h2>MRP: ₹90,499.00</h2>
            <input type="number" value="1">
            <button class="normal">Add To Cart</button>
            <h4>Product Details</h4>
            <span>
                A 12MP camera in the sky delivers content guaranteed to impress | 4K/30fps video and a 3-axis motorized
                gimbal | At less than 249 g | With a max battery life of 31 minutes | take off max altitude of
                4,000 meters
            </span>
