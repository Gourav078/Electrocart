...
<body>
  ...
  <section id="prodetail" class="section-p1">
    <div class="single-pro-image">
      <img src="images/dellinspirion15.jpg" width="100%" id="mainimg">
      <div class="small-img-g">
        <div class="small-img-col">
          <img src="images/dellinspirion152nd.jpg" width="100% " class="small-img">
        </div>
        <div class="small-img-col">
          <img src="images/dellinspirion153nd.jpg" width="100% " class="small-img">
        </div>
        <div class="small-img-col">
          <img src="images/dellinspirion154th.jpg" width="100% " class="small-img">
        </div>
        <div class="small-img-col">
          <img src="images/dellinspirion15.jpg" width="100% " class="small-img">
        </div>
      </div>
    </div>
    <div class="sigle-pro-details">
      <!-- <h6>Mobile</h6> -->
      <h4>Dell Inspiron 3567 i3 7th Gen(4GB/1TB HDD/Windows 10 Home/MS
        Office/Blue/2.5kg)</h4>
      <h2>MRP: ₹59,499.00</h2>
      <input type="number" value="1">
      <button class="normal">Add To Cart</button>
      <h4>Product Details</h4>
      <span>Intel Core i3-7020U, 2.3GHz base processor speed | Pre-loaded Windows 10 | 15.6-inch FHD display | 4GB DDR4
        RAM | 1TB HDD | MS Office Home & Student 2016 |
        Laptop with included battery and charger | Decrease Power consumption.
      </span>
