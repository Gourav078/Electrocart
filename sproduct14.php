...
<body>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="images/poco-x4-pro-5g.png" width="100%" id="mainimg">
            <div class="small-img-g">
                <div class="small-img-col">
                    <img src="images/poco-x4-pro-5g1.png" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/poco-x4-pro-5g2.png" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/poco-x4-pro-5g3.png" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/poco-x4-pro-5g4.png" width="100% " class="small-img">
                </div>
            </div>
        </div>
        <div class="sigle-pro-details">
            <!-- <h6>Mobile</h6> -->
            <h4>POCO X4 Pro 5G (Laser Blue, 64 GB) (6 GB RAM)</h4>
            <h2>MRP: ₹19,499.00</h2>
            <input type="number" value="1">
            <button class="normal">Add To Cart</button>
            <h4>Product Details</h4>
            <span>48MP Sony IMX 789 Lens, 50MP Ultra-wide & 8MP Tele photo
                lens | 32MP | Hasselblad Camera | 6.7 Inches; 120 Hz QHD+ Fluid AMOLED | Oxygen OS
                based on Android 12 | Snapdragon 8 Gen 1 | 5000 mAh with 80W SuperVOOC.
            </span>
