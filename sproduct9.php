...
<body>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="images/oneplus_10_pro.webp" width="100%" id="mainimg">
            <div class="small-img-g">
                <div class="small-img-col">
                    <img src="images/o10pro1.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/o10pro2.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/o10pro3.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/o10pro4.jpg" width="100% " class="small-img">
                </div>
            </div>
        </div>
        <div class="sigle-pro-details">
            <!-- <h6>Mobile</h6> -->
            <h4>OnePlus 10 Pro 5G (Emerald Forest, 8GB RAM, 128GB Storage)</h4>
            <h2>MRP: ₹59,499.00</h2>
