...
<body>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="images/alienware laptops1.jpg" width="100%" id="mainimg">
            <div class="small-img-g">
                <div class="small-img-col">
                    <img src="images/alienware laptops1.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/alienware laptops4.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/alienware laptops3.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/alienware laptops4.jpg" width="100% " class="small-img">
                </div>
