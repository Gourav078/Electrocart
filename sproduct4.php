...
<body>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="images/samsungs22.jpg" width="100%" id="mainimg">
            <div class="small-img-g">
                <div class="small-img-col">
                    <img src="images/samsungs22.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/samsungs222.png" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/samsungs22.jpg" width="100% " class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/samsungs223.jpg" width="100% " class="small-img">
                </div>
            </div>
        </div>
        <div class="sigle-pro-details">
            <!-- <h6>Mobile</h6> -->
            <h4>Samsung Galaxy S22(Phantom White, 8GB, 128GB Storage)</h4>
            <h2>MRP: ₹74,999.00</h2>
            <input type="number" value="1">
            <button class="normal">Add To Cart</button>
            <h4>Product Details</h4>
            <span>120Hz Dynamic AMOLED 2X display | Pro-grade Camera that lets you make your nights epic | 4nm
                processor, our fastest chip | the Super Clear Glass dials down lens flare, and fast-acting AI delivers
                near-instant intelligent processing.
            </span>
